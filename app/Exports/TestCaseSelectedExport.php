...
class TestCaseSelectedExport implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles
{
    protected $ids;
    ...
    public function collection()
    {
        ...
        ->whereIn('test_case_id', $this->ids)
        ->orderByRaw('FIELD(test_case_id, ' . implode(',', $this->ids) . ')') // Menjaga urutan berdasarkan ID yang dipilih
        ->get()
        ->map(function ($testcase) {
            return [
                'Number' => $testcase->nomor, // Mempertahankan nomor asli dari database
