...
<body class="container m-auto bg-gray-200 dark:bg-slate-900">
            ...
            <nav class="fixed w-full z-20 top-0 start-0 bg-opacity-90 backdrop-blur-md dark:bg-opacity-50 shadow">
                <div
                    ...
                    <a href="" class="flex items-center space-x-3 rtl:space-x-reverse">
                        ...
                        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Repository
                            Test Case
                        </span>
                    </a>
    ...
    <section class="bg-transparent">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
            <h1
                ...
                Reusable Test Case Repository</h1>
            <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">A
                template-based test case repository designed to improve efficiency and ensure consistency in mobile
    ...
    <section id="About" class="mt-40 py-10 bg-transparent sm:py-16 lg:py-36 pt-24 pb-48 rounded-lg">
        <div class="max-w-7xl mx-auto">
            <h1 class="text-4xl font-bold mb-6 text-center text-white">Available Test Cases</h1>
                ...
                <div class="w-full p-24 py-6 lg:py-8 shadow-lg">
                    ...
                    <div class="sm:flex sm:items-center sm:justify-between">
                        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="#"
                                class="hover:underline">RepositoryTestCase</a>. All
                            Rights
                            Reserved.
                        </span>
