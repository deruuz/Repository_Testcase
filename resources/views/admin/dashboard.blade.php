...
@section('content')
  ...
  >
    ...
    <div
      class="w-full bg-white rounded-lg shadow-sm dark:bg-gray-800 p-4 md:p-6 mb-4"
    >
    ...
    <div class="flex col-2 space-x-2">
      ...
      <div
        class="max-w-sm w-full bg-white rounded-lg shadow-sm dark:bg-gray-800 p-4 md:p-6 mb-4"
      >
