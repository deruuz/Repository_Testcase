...
<html lang="en">
  ...
  <header class="p-5 flex justify-between items-center bg-gray-800">
    ...
    >
      <span
        class="absolute w-0 h-0 transition-all duration-500 ease-out bg-gradient-to-r from-blue-300 via-blue-500 to-purple-600 rounded-full group-hover:w-56 group-hover:h-56"
      ></span>
